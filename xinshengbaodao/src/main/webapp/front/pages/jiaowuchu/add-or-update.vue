    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'
                      class="title">教务负责人名称</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaowuchuName" type="text" v-model="ruleForm.jiaowuchuName" placeholder="教务负责人名称"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="jiaowuchuPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'
                          class="title">头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.jiaowuchuPhoto" :src="ruleForm.jiaowuchuPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaowuchuPhone" type="text" v-model="ruleForm.jiaowuchuPhone" placeholder="联系方式"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaowuchuEmail" type="text" v-model="ruleForm.jiaowuchuEmail" placeholder="邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`jiaowuchu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.jiaowuchuId){
                this.ruleForm.jiaowuchuId = options.jiaowuchuId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
			...
			jiaowuchuPhotoTap() {
                ...
                this.$api.upload(function(res) {
                    _this.ruleForm.jiaowuchuPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.jiaowuchuName)) {
                    this.$utils.msg(`教务负责人名称不能为空`);
                    return
                }
				if ((!this.ruleForm.jiaowuchuPhoto)) {
				...
				if ((!this.ruleForm.jiaowuchuPhone) && (!this.$validate.isMobile(this.ruleForm.jiaowuchuPhone))) {
                    this.$utils.msg(`联系方式不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiaowuchuEmail) && (!this.$validate.isEmail(this.ruleForm.jiaowuchuEmail))) {
                    this.$utils.msg(`邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`jiaowuchu`, this.ruleForm);
                } else {
                    await this.$api.save(`jiaowuchu`, this.ruleForm);
                }
