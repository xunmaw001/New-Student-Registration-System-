<template>
	<view class="content">
		<view
			...
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>账户
			</view>
		...
		<view
			:style='{"boxShadow":"0 0 2rpx #07A771","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"#47EDB5","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
			v-if="tableName=='yonghu'" class="cu-form-group">
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>学生姓名
			</view>
			<input style="padding: 0 30upx"
				:style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
				v-model="ruleForm.yonghuName" placeholder="学生姓名"></input>
		</view>
		<view
			:style='{"boxShadow":"0 0 2rpx #07A771","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"#47EDB5","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
			v-if="tableName=='yonghu'" @tap="yonghuPhotoTap" class="cu-form-group">
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>头像
			</view>
			<image
		...
		<view v-if="tableName=='yonghu'"
			...
			<view :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}' class="title">性别
			</view>
		...
		<view
			:style='{"boxShadow":"0 0 2rpx #07A771","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"#47EDB5","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
			v-if="tableName=='yonghu'" class="cu-form-group">
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>联系方式
			</view>
			<input style="padding: 0 30upx"
				:style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
		...
		<view
			:style='{"boxShadow":"0 0 2rpx #07A771","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"#47EDB5","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
			v-if="tableName=='yonghu'" class="cu-form-group">
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>身份证号
			</view>
			<input style="padding: 0 30upx"
				:style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
		...
		<view
			:style='{"boxShadow":"0 0 2rpx #07A771","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"#47EDB5","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
			v-if="tableName=='yonghu'" class="cu-form-group">
			<view class="title" :style='{"width":"160rpx","fontSize":"28rpx","color":"#47EDB5","textAlign":"left"}'>邮箱
			</view>
			<input style="padding: 0 30upx"
				:style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#47EDB5","borderRadius":"0px","color":"#47EDB5","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
	...
	export default {
		...
		async onLoad() {
			...
			if (this.tableName == 'yonghu') {
				...
				let yonghu_typesParams = {
					page: 1,
					limit: 100,
					dicCode: 'yonghu_types',
				}
				let yonghu_typesRes = await this.$api.page(`dictionary`, yonghu_typesParams);

				this.yonghuTypesOptions = yonghu_typesRes.data.list
				let zhuanye_typesParams = {
					page: 1,
					limit: 100,
					dicCode: 'zhuanye_types',
				}
				let zhuanye_typesRes = await this.$api.page(`dictionary`, zhuanye_typesParams);

				this.zhuanyeTypesOptions = zhuanye_typesRes.data.list
			}
			// this.styleChange()
		},
		methods: {
