	...
	<view>
        ...
        <view class="username">
			<text v-if="forum.yonghuId != null">
				 发布人：{{forum.yonghuName}}（学生）
			</text>
			<text v-if="forum.jiaowuchuId != null">
				 发布人：{{forum.jiaowuchuName}}（教务处）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        ...
                        <image v-if="comment.jiaowuchuId != null" class="image" :src="comment.jiaowuchuPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							...
							<text v-if="comment.jiaowuchuId != null">{{comment.jiaowuchuName}}</text>
