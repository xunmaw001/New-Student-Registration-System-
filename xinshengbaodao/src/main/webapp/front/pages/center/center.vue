	...
	<view class="content">
		<view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
			...
			<view v-if="tableName=='yonghu'" class="userinfo">
				...
				<view class="info">
					...
					<view class="username" v-if="user.yonghuTypes == 2"
						:style='{"boxShadow":"0 0 16rpx rgba(255,255,255,0)","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1.0)","textAlign":"left","borderWidth":"0","width":"240rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>
						专业：{{user.zhuanyeValue}}
					</view>
					<view class="username" v-if="user.yonghuTypes == 2"
						:style='{"boxShadow":"0 0 16rpx rgba(255,255,255,0)","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1.0)","textAlign":"left","borderWidth":"0","width":"240rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>
						报告状态：{{user.yonghuValue}}
					</view>
				</view>
			</view>
		...
		<view class="list">
			...
			<view @tap="onPageTap('../forum/forum-my')"
				...
				<view class="text" :style='{"color":"#47EDB5","fontSize":"28rpx"}'>我的发贴</view>
				<!-- <image class="to" :style='{"color":"#47EDB5","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
				<view class="cuIcon-right" :style='{"color":"#47EDB5","fontSize":"28rpx"}'></view>
			</view>
