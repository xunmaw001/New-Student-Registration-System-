<template>
	...
	<scroll-view scroll-x="true" class="tabView"
		...
		<view :style='categoryName===item.codeIndex?sactiveItem:sitem' class="tab"
			  v-for="(item,index) in yonghuTypesList" :key="index"
		...
		async onShow() {
            ...
            _this.btnColor = _this.btnColor.sort(() => {
		  	...
		  	this.sexTypesList = sexTypes.data.list;
	   		//当前表的 报到状态 字段 字典表查询方法
		  	let yonghuTypes = await this.$api.page('dictionary', {
			 	 page: 1,
			  	limit: 100,
		  		dicCode:'yonghu_types'
		  	});
		  	this.yonghuTypesList = yonghuTypes.data.list;
	   		//当前表的 专业 字段 字典表查询方法
				...
				let params = {
                    ...
                    ,yonghuDelete: 1
							...
							if (this.categoryName != 0) {
                                params.yonghuTypes = this.categoryName
                            }
