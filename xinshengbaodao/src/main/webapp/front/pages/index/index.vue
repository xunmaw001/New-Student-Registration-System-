...
<view class="list" :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
    <view :style='{"borderRadius":"8rpx","backgroundColor":"#47EDB5"}' @tap="onNewsDetailTap(item.id)" v-for="(item,index) in newsList " v-bind:key="index" class="listm flex flex-between">
