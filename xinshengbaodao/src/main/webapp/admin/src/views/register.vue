<template>
    <div style="backgroundImage: url('/xinshengbaodao/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">新生报到系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="教务负责人名称" class="input" v-if="tableName=='jiaowuchu'">
                            <el-input v-model="ruleForm.jiaowuchuName" autocomplete="off" placeholder="教务负责人名称"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jiaowuchu'">
                            <el-input v-model="ruleForm.jiaowuchuPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='jiaowuchu'">
                            <el-input v-model="ruleForm.jiaowuchuEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jiaowuchuName)&& 'jiaowuchu'==this.tableName){
                                this.$message.error('教务负责人名称不能为空');
                                return
                            }
                             if('jiaowuchu' == this.tableName && this.ruleForm.jiaowuchuPhone&&(!this.$validate.isMobile(this.ruleForm.jiaowuchuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('jiaowuchu' == this.tableName && this.ruleForm.jiaowuchuEmail&&(!this.$validate.isEmail(this.ruleForm.jiaowuchuEmail))){
