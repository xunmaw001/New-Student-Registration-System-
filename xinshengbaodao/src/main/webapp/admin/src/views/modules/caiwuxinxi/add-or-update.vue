    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报到状态" prop="yonghuValue">
                        <el-input v-model="yonghuForm.yonghuValue"
                                  placeholder="报到状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="报到状态" prop="yonghuValue">
                            <el-input v-model="ruleForm.yonghuValue"
                                      placeholder="报到状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <input id="updateId" name="id" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="caiwuxinxiName">
                       <el-input v-model="ruleForm.caiwuxinxiName"
                                 placeholder="标题" clearable  :readonly="ro.caiwuxinxiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="caiwuxinxiName">
                           <el-input v-model="ruleForm.caiwuxinxiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="财务类型" prop="caiwuxinxiTypes">
                        <el-select v-model="ruleForm.caiwuxinxiTypes" :disabled="ro.caiwuxinxiTypes" placeholder="请选择财务类型">
                            <el-option
                                v-for="(item,index) in caiwuxinxiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="财务类型" prop="caiwuxinxiValue">
                        <el-input v-model="ruleForm.caiwuxinxiValue"
                            placeholder="财务类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="相关金额" prop="caiwuxinxiMoney">
                       <el-input v-model="ruleForm.caiwuxinxiMoney"
                                 placeholder="相关金额" clearable  :readonly="ro.caiwuxinxiMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="相关金额" prop="caiwuxinxiMoney">
                           <el-input v-model="ruleForm.caiwuxinxiMoney"
                                     placeholder="相关金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   caiwuxinxiMoney: [
                              { required: true, message: '相关金额不能为空', trigger: 'blur' },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=caiwuxinxi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.caiwuxinxiTypesOptions = data.data.list;
                    }
                });
