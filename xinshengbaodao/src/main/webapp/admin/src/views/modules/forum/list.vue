            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.jiaowuchuId">
                            教务处
                        </span>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xinshengbaodao/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.zhuanyeTypes = el.zhuanyeTypes;
                            forum.yonghuDelete = el.yonghuDelete;
                            forum.createTime = el.createTime;
                            forum.jiaowuchuId = el.jiaowuchuId;//---
                            forum.jiaowuchuName = el.jiaowuchuName;
                            forum.jiaowuchuPhoto = el.jiaowuchuPhoto;
                            forum.jiaowuchuPhone = el.jiaowuchuPhone;
                            forum.jiaowuchuEmail = el.jiaowuchuEmail;
                            forum.jiaowuchuDelete = el.jiaowuchuDelete;
                            forum.createTime = el.createTime;
