    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="专业确认" prop="zhuanyeTypes">
                        <el-select v-model="ruleForm.zhuanyeTypes" :disabled="ro.zhuanyeTypes" placeholder="请选择专业确认">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="专业确认" prop="zhuanyeValue">
                        <el-input v-model="ruleForm.zhuanyeValue"
                            placeholder="专业确认" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身份信息" prop="yidaobaogaoPaizhao">
                       <el-input v-model="ruleForm.yidaobaogaoPaizhao"
                                 placeholder="身份信息" clearable  :readonly="ro.yidaobaogaoPaizhao"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="身份信息" prop="yidaobaogaoPaizhao">
                           <el-input v-model="ruleForm.yidaobaogaoPaizhao"
                                     placeholder="身份信息" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zhuanyeTypes: [
                              { required: true, message: '专业确认不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yidaobaogao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yidaobaogaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yidaobaogao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yidaobaogaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
