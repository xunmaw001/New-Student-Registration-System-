<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jiaowuchu'"  label='教务负责人名称' prop="jiaowuchuName">
               <el-input v-model="ruleForm.jiaowuchuName"  placeholder='教务负责人名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='jiaowuchu'" label='头像' prop="jiaowuchuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaowuchu'"  label='联系方式' prop="jiaowuchuPhone">
               <el-input v-model="ruleForm.jiaowuchuPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='jiaowuchu'"  label='邮箱' prop="jiaowuchuEmail">
               <el-input v-model="ruleForm.jiaowuchuEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='报到状态' prop="yonghuTypes">
                 <el-select v-model="ruleForm.yonghuTypes"  placeholder='请选择报到状态'>
                     <el-option
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.jiaowuchuName)&& 'jiaowuchu'==this.flag){
                             this.$message.error('教务负责人名称不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaowuchuPhoto)&& 'jiaowuchu'==this.flag){
                             this.$message.error('头像不能为空');
                             return
                         }

                         if((!this.ruleForm.jiaowuchuPhone)&& 'jiaowuchu'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                             if( 'jiaowuchu' ==this.flag && this.ruleForm.jiaowuchuEmail&&(!isEmail(this.ruleForm.jiaowuchuEmail))){
