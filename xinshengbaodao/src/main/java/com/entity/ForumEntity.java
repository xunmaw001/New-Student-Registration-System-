...
public class ForumEntity<T> implements Serializable {
     ...
     * 教务处
     */
    @TableField(value = "jiaowuchu_id")

    private Integer jiaowuchuId;
    ...
    public void setJiaowuchuId(Integer jiaowuchuId) {
        this.jiaowuchuId = jiaowuchuId;
    }
    /**
	 * 设置：管理员
	 */
