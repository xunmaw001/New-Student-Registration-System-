                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setYonghuName(data.get(1));                    //学生姓名 要改的
                            yonghuEntity.setYonghuPhoto(null);//详情和图片
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(2)));   //性别 要改的
                            yonghuEntity.setYonghuPhone(data.get(3));                    //联系方式 要改的
                            yonghuEntity.setYonghuIdNumber(data.get(4));                    //身份证号 要改的
                            yonghuEntity.setYonghuEmail(data.get(5));                    //邮箱 要改的
                            yonghuEntity.setYonghuTypes(1);   //报到状态 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("yonghuPhone")){
                                    ...
                                    yonghuPhone.add(data.get(3));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("yonghuIdNumber")){
                                    ...
                                    yonghuIdNumber.add(data.get(4));//要改的
                                }else{
